...
$jscomp.polyfillIsolated = function(a, c, b, e) {
    ...
    null != c && (a ? $jscomp.defineProperty($jscomp.polyfills, d, {
        ...
        writable: !0,
        value: c
    }) : c !== b && ($jscomp.propertyToPolyfillSymbol[d] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(d) : $jscomp.POLYFILL_PREFIX + d, d =
...
(function(a) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net-bs5", "datatables.net-responsive"], function(c) {
    ...
    var d = e.modal,
        f = a('<div class="modal fade dtr-bs-modal" role="dialog"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div><div class="modal-body"/></div></div></div>'),
        g, l = c.bootstrap;
        ...
        return function(m, k, n) {
            if (!a.fn.modal) d(m, k, n);
                ...
                if (h && h.header) {
                    ...
                    k.empty().append('<h4 class="modal-title">' + h.header(m) + "</h4>").append(p)
                }
