...
(function(h) {
    ...
    }) : "object" === typeof exports ? module.exports = function(r, w) {
        r || (r = window);
        w && w.fn.dataTable || (w = require("datatables.net")(r, w).$);
        return h(w, r, r.document)
    ...
    function J(a) {
        ...
        h("body").on("click.dtSelect" + D(a.table().node()), function(g) {
            if (c._select.blurable && !h(g.target).parents().filter(a.table().container()).length && 0 !== h(g.target).parents("html").length && !h(g.target).parents("div.DTE").length) {
                var f = h.Event("select-blur.dt");
                u(a, f, [g.target, g]);
                f.isDefaultPrevented() || z(c, !0)
            }
        })
    }
    ...
    function O(a) {
        ...
        a.aoRowCreatedCallback.push({
            fn: function(c, d, e) {
                ...
                c = 0;
                for (e = a.aoColumns.length; c < e; c++)(a.aoColumns[c]._select_selected || d._selected_cells && d._selected_cells[c]) && h(d.anCells[c]).addClass(a._select.className)
            },
    ...
    function E(a, b, c, d, e) {
        ...
        if (!k || f) "os" === g ? a.ctrlKey || a.metaKey ? b[d](e).select(!k) : a.shiftKey ? "cell" === d ? I(b, e, c._select_lastCell || null) : K(b, d, e, c._select_lastCell ? c._select_lastCell[d] : null) : (a = b[d + "s"]({
                selected: !0
            }), k && 1 === a.flatten().length ? b[d](e).deselect() : (a.deselect(), b[d](e).select())) : "multi+shift" == g ? a.shiftKey ? "cell" === d ? I(b, e, c._select_lastCell || null) : K(b, d, e, c._select_lastCell ? c._select_lastCell[d] : null) : b[d](e).select(!k) :
            b[d](e).select(!k)
    }
    ...
    m.select.init = function(a) {
        ...
        if (!b._select) {
            ...
            b._select = {};
            !0 === e ? (f = "os", B = !0) : "string" ===
                typeof e ? (f = e, B = !0) : h.isPlainObject(e) && (e.blurable !== l && (k = e.blurable), e.toggleable !== l && (n = e.toggleable), e.info !== l && (q = e.info), e.items !== l && (g = e.items), f = e.style !== l ? e.style : "os", B = !0, e.selector !== l && (y = e.selector), e.className !== l && (M = e.className));
            a.select.selector(y);
            a.select.items(g);
            a.select.style(f);
            a.select.blurable(k);
    ...
    v("row().selected()", function() {
        var a = this.context[0];
        return a && this.length && a.aoData[this[0]] && a.aoData[this[0]]._select_selected ? !0 : !1
    });
    x("columns().select()", "column().select()", function(a) {
        var b = this;
        if (!1 === a) return this.deselect();
        this.iterator("column", function(c,
            d) {
            z(c);
    ...
    v("column().selected()", function() {
        var a = this.context[0];
        return a && this.length && a.aoColumns[this[0]] && a.aoColumns[this[0]]._select_selected ? !0 : !1
    });
    ...
    v("cell().selected()", function() {
        var a = this.context[0];
        return a && this.length && (a = a.aoData[this[0][0].row]) && a._selected_cells && a._selected_cells[this[0][0].column] ? !0 : !1
    });
    ...
    x("cells().deselect()", "cell().deselect()", function() {
        ...
        this.iterator("cell", function(b, c, d) {
            ...
            c.anCells && !b.aoColumns[d]._select_selected &&
    ...
    h(w).on("preInit.dt.dtSelect", function(a, b) {
