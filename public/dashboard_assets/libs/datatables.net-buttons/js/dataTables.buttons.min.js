...
(function(d) {
    ...
    d.extend(x.prototype, {
        ...
        _buildButton: function(a, b, c, e) {
            ...
            if (a.hasOwnProperty("html")) var k = d(a.html);
                ...
                k = d("<" + g + "/>").addClass(h.className).addClass(e ? this.c.dom.splitDropdownButton.className : "").attr("tabindex", this.s.dt.settings()[0].iTabIndex).attr("aria-controls", this.s.dt.table().node().id).on("click.dtb", function(v) {
                    v.preventDefault();
                    !k.hasClass(h.disabled) && a.action && t(v, r, k, a);
                    y && k.trigger("blur")
                }).on("keypress.dtb",
                    function(v) {
                        13 === v.keyCode && (v.preventDefault(), !k.hasClass(h.disabled) && a.action && t(v, r, k, a))
                    });
            ...
            if (c) {
                ...
                var B = function(v, E, F, G) {
                        D.split.action.call(E.button(d("div.dt-btn-split-wrapper")[0]), v, E, F, G);
                        d(E.table().node()).triggerHandler("buttons-action.dt", [E.button(F), E, F, G]);
                    ...
                    z = d('<button class="' + this.c.dom.splitDropdown.className + ' dt-button"><span class="dt-btn-split-drop-arrow">' + this.c.dom.splitDropdown.text + "</span></button>").on("click.dtb", function(v) {
                        ...
                        13 === v.keyCode && (v.preventDefault(), z.hasClass(h.disabled) || B(v, r, z, w))
                    });
        ...
        _popover: function(a, b, c, e) {
            ...
            if (!1 ===
                ...
                var m = d("<div/>").addClass("dt-button-collection").addClass(f.collectionLayout).addClass(f.splitAlignClass).addClass(e).css("display", "none").attr({
                    "aria-modal": !0,
                    role: "dialog"
                });
                ...
                if ("absolute" === r) {
                    ...
                    z > B && (z = B);
                    m.css("marginTop", -1 * z)
                }, r(), d(A).on("resize.dtb-collection", function() {
                    r()
                });
                ...
                setTimeout(function() {
                    ...
                    d("body").on("click.dtb-collection", function(B) {
                        if (!h) {
                            ...
                            (!d(B.target).parents()[z]().filter(a).length && !d(v).hasClass("dt-buttons") || d(B.target).hasClass("dt-button-background")) && l()
                        }
        ...
        for (var c = [], e = function(l, m, r) {
                ...
                if (Array.isArray(l) ||
                    ...
                    for (l = l.replace(":name",
                            ""), n = 0, r = q.length; n < r; n++) q[n].name === l && c.push({
                        inst: m,
                        node: q[n].node
                    });
    ...
    var K = function(a) {
        ...
        Q = function(a, b) {
            ...
            f = f.nodes().toArray();
            for (var g =
                    b.length, l = [], m = 0, r = 0, q = 0 < g ? h.length / g : 0; r < q; r++) {
