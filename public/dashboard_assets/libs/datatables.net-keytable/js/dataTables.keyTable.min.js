...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(b, h, k) {
...
$jscomp.polyfill = function(b, h, k, m) {
    h && ($jscomp.ISOLATE_POLYFILLS ? $jscomp.polyfillIsolated(b, h, k, m) : $jscomp.polyfillUnisolated(b, h, k, m))
};
$jscomp.polyfillUnisolated = function(b, h, k, m) {
    k = $jscomp.global;
    b = b.split(".");
    ...
    m = k[b];
    h = h(m);
    h != m && null != h && $jscomp.defineProperty(k, b, {
        configurable: !0,
        writable: !0,
        value: h
    })
};
$jscomp.polyfillIsolated = function(b, h, k, m) {
    var n = b.split(".");
    b = 1 === n.length;
    m = n[0];
    ...
    h = h(k);
    null != h && (b ? $jscomp.defineProperty($jscomp.polyfills, n, {
        configurable: !0,
        writable: !0,
        value: h
    }) : h !== k && ($jscomp.propertyToPolyfillSymbol[n] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(n) : $jscomp.POLYFILL_PREFIX + n, n =
        $jscomp.propertyToPolyfillSymbol[n], $jscomp.defineProperty(m, n, {
            configurable: !0,
            writable: !0,
            value: h
        })))
...
(function(b) {
    ...
    b.extend(t.prototype, {
        ...
        _constructor: function() {
            ...
            b(c.table().body()).on("click" + d, "th, td", function(g) {
                if (!1 !== a.s.enable) {
                    var q = c.cell(this);
                    q.any() && a._focus(q, null, !1, g)
                }
            });
            b(k).on("keydown" + d, function(g) {
                f || a._key(g)
            });
            if (this.c.blurable) b(k).on("mousedown" + d, function(g) {
                b(g.target).parents(".dataTables_filter").length && a._blur();
                b(g.target).parents().filter(c.table().container()).length ||
                    b(g.target).parents("div.DTE").length || b(g.target).parents("div.editor-datetime").length || b(g.target).parents("div.dt-datetime").length || b(g.target).parents().filter(".DTFC_Cloned").length || a._blur()
            });
            if (this.c.editor) {
                var p = this.c.editor;
                p.on("open.keyTableMain", function(g, q, r) {
                    "inline" !== q && a.s.enable && (a.enable(!1), p.one("close" + d, function() {
                        a.enable(!0)
                    }))
                });
                if (this.c.editOnFocus) c.on("key-focus" + d + " key-refocus" + d, function(g, q, r, v) {
                    a._editor(null, v, !0)
                });
                c.on("key" + d, function(g, q, r, v, x) {
                    a._editor(r,
                        x, !1)
                });
                b(c.table().body()).on("dblclick" + d, "th, td", function(g) {
                    !1 !== a.s.enable && c.cell(this).any() && (a.s.lastFocus && this !== a.s.lastFocus.cell.node() || a._editor(null, g, !0))
                });
            ...
            c.on("stateSaveParams" + d, function(g, q, r) {
                r.keyTable = a.s.lastFocus ? a.s.lastFocus.cell.index() : null
            });
            c.on("column-visibility" + d, function(g) {
                a._tabInput()
            });
            c.on("draw" + d, function(g) {
                a._tabInput();
                if (!a.s.focusDraw &&
                    a.s.lastFocus) {
                    var q = a.s.lastFocus.relative,
                        r = c.page.info(),
                        v = q.row + r.start;
                    0 !== r.recordsDisplay && (v >= r.recordsDisplay && (v = r.recordsDisplay - 1), a._focus(v, q.column, !0, g))
                }
            });
        ...
        _clipboard: function() {
            var a = this.s.dt,
                c = this,
                e = this.s.namespace;
            h.getSelection && (b(k).on("copy" + e, function(d) {
                d = d.originalEvent;
                var f = h.getSelection().toString(),
                    p = c.s.lastFocus;
                !f && p && (d.clipboardData.setData("text/plain",
            ...
            if (this.s.lastFocus && (!c || "draw" !== c.type)) {
                ...
                if (!(b("div.DTE", l.node()).length || null !== a && (0 <= a && 9 >= a || 11 === a || 12 === a || 14 <= a && 31 >= a || 112 <= a && 123 >= a || 127 <= a && 159 >= a))) {
                    ...
                    var q = function() {
                        ...
                        p.one("open" + g, function() {
                            p.off("cancelOpen" + g);
                            e || b("div.DTE_Field_InputControl input, div.DTE_Field_InputControl textarea").select();
                            f.keys.enable(e ? "tab-only" : "navigation-only");
                            f.on("key-blur.editor", function(v, x, y) {
                                p.displayed() && y.node() === l.node() && p.submit()
                            });
                            e && b(f.table().container()).addClass("dtk-focus-alt");
                            p.on("preSubmitCancelled" + g, function() {
                                setTimeout(function() {
                                    d._focus(l, null, !1)
                                }, 50)
                            });
                            p.on("submitUnsuccessful" + g, function() {
                                d._focus(l,
                                    null, !1)
                            });
                            p.one("close" + g, function() {
                                f.keys.enable(!0);
                                f.off("key-blur.editor");
                                p.off(g);
                                b(f.table().container()).removeClass("dtk-focus-alt");
                                d.s.returnSubmit && (d.s.returnSubmit = !1, d._emitEvent("key-return-submit", [f, l]))
                            })
                        }).one("cancelOpen" + g, function() {
                            p.off(g)
        ...
        _inlineOptions: function(a) {
            return this.c.editorOptions ? this.c.editorOptions(a) : {
                cell: a,
                field: m,
                options: m
            }
        ...
        _focus: function(a, c, e, d) {
            ...
            if (this.s.enable) {
                ...
                if (-1 !== l.length && (a < l.start || a >= l.start + l.length)) this.s.focusDraw = !0, this.s.waitingForDraw = !0, p.one("draw", function() {
                    ...
                    if (e === m || !0 === e) this._scroll(b(h), b(k.body), g, "offset"), e = p.table().body().parentNode, e !== p.table().header().parentNode &&
                        (e = b(e.parentNode), this._scroll(e, e, g, "position"));
                    this.s.lastFocus = {
                        cell: l,
                        node: l.node(),
                        relative: {
        ...
        _key: function(a) {
            if (this.s.waitingForDraw) a.preventDefault();
                ...
                var c = this.s.enable;
                this.s.returnSubmit = "navigation-only" !== c && "tab-only" !== c || 13 !== a.keyCode ? !1 : !0;
                var e = !0 === c || "navigation-only" === c;
                if (c && (!(0 === a.keyCode || a.ctrlKey || a.metaKey ||
                        a.altKey) || a.ctrlKey && a.altKey)) {
                    var d = this.s.lastFocus;
                    if (d)
                        if (this.s.dt.cell(d.node).any()) {
                            d = this.s.dt;
                            var f = this.s.dt.settings()[0].oScroll.sY ? !0 : !1;
                            if (!this.c.keys || -1 !== b.inArray(a.keyCode, this.c.keys)) switch (a.keyCode) {
                                case 9:
                                    this._shift(a, a.shiftKey ? "left" : "right", !0);
                                    break;
                                case 27:
                                    this.c.blurable && !0 === c && this._blur();
                                    break;
                                case 33:
                                case 34:
                                    e && !f && (a.preventDefault(), d.page(33 === a.keyCode ? "previous" : "next").draw(!1));
                                    break;
                                case 35:
                                case 36:
                                    e && (a.preventDefault(), c = d.cells({
                                        ...
                                        e = this._columns(), this._focus(d.cell(c[35 === a.keyCode ? c.length - 1 : e[0]]), null, !0, a));
                                    break;
                                case 37:
        ...
        _scroll: function(a, c, e, d) {
            var f = e[d](),
                ...
                r = a.height();
            a = a.width();
            "position" === d && (f.top += parseInt(e.closest("table").css("top"), 10));
            f.top < g && c.scrollTop(f.top);
            f.left < q && c.scrollLeft(f.left);
            f.top + p > g + r && p < r && c.scrollTop(f.top + p - r);
            f.left + l > q + a && l < a && c.scrollLeft(f.left + l - a)
        },
        ...
        _tabInput: function() {
            var a = this,
                ...
                e = null !== this.c.tabIndex ? this.c.tabIndex : c.settings()[0].iTabIndex; - 1 != e && (this.s.tabInput || (e = b('<div><input type="text" tabindex="' + e + '"/></div>').css({
                    ...
                    var f = c.cell(":eq(0)", a._columns(), {
                        page: "current"
                    });
                    f.any() && a._focus(f, null, !0, d)
    ...
    n.Api.register("keys.enable()", function(a) {
        return this.iterator("table", function(c) {
            c.keytable && c.keytable.enable(a === m ? !0 : a)
        })
    });
    ...
    n.ext.selector.cell.push(function(a, c, e) {
        c = c.focused;
        a = a.keytable;
        var d = [];
        if (!a || c === m) return e;
        for (var f = 0, p = e.length; f < p; f++)(!0 === c && a.focused(e[f]) || !1 === c && !a.focused(e[f])) && d.push(e[f]);
        return d
    });
    b(k).on("preInit.dt.dtk", function(a, c, e) {
        "dt" === a.namespace && (a = c.oInit.keys, e = n.defaults.keys,
            a || e) && (e = b.extend({}, e, a), !1 !== a && new t(c, e))
    });
    return t
});