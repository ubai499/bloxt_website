...
function _arrayLikeToArray(e, t) {
    ...
    function e() {
        ...
        }), 0 < r('[data-plugin="tippy"]').length && tippy('[data-plugin="tippy"]'), r("[data-password]").on("click", function() {
            "false" == r(this).attr("data-password") ? (r(this).siblings("input").attr("type", "text"), r(this).attr("data-password", "true"), r(this).addClass("show-password")) : (r(this).siblings("input").attr("type", "password"), r(this).attr("data-password", "false"), r(this).removeClass("show-password"))
    ...
    var t, n, o, a;
    e(), r(document).on("click", '.card a[data-bs-toggle="remove"]', function(e) {
        e.preventDefault();
    ...
    }), t = r(".navbar-custom .dropdown:not(.app-search)"), r(document).on("click", function(e) {
    ...
    }), (n = document.querySelector('[data-toggle="fullscreen"]')) && n.addEventListener("click", function(e) {
    ...
    }), jQuery().select2 && r('[data-toggle="select2"]').select2(), jQuery().mask && r('[data-toggle="input-mask"]').each(function(e, t) {
        var n = r(t).data("maskFormat"),
            a = r(t).data("reverse");
        null != a ? r(t).mask(n, {
            reverse: a
        }) : r(t).mask(n)
    }), jQuery().daterangepicker && (o = {
        ...
        var n = r.extend({}, a, r(t).data());
        r(t).timepicker(n)
    })), jQuery().TouchSpin && (a = {}, r('[data-toggle="touchspin"]').each(function(e, t) {
        var n = r.extend({}, a, r(t).data());
        r(t).TouchSpin(n)
    })), jQuery().maxlength && (a = {
...
var ThemeCustomizer = function() {
    ...
    return _createClass(e, [{
        ...
        value: function() {
            var e, t;
            this.initLeftSidebar(), null !== (e = document.querySelector(".app-menu .scrollbar")) && void 0 !== e && e.setAttribute("data-simplebar", ""), null !== (t = document.querySelector(".app-menu .scrollbar")) && void 0 !== t && t.classList.add("h-100")
        }
    }, {
        key: "initLeftSidebar",
        value: function() {
            var n, a, t, o, r, i = this;
            $(".menu").length && (o = $(".menu li .collapse"), $(".menu li [data-bs-toggle='collapse']").on("click", function(e) {
                return !1
            }), o.on({
                ...
                var e, t, n, a = window.location.href.split(/[?#]/)[0];
                this.href == a && ($(this).addClass("active"), $(this).parent().addClass("menuitem-active"), $(this).parent().parent().parent().addClass("show"), $(this).parent().parent().parent().parent().addClass("menuitem-active"), $(this).parent().parent().parent().parent().parent().parent().parent().addClass("menuitem-active"), "sidebar-menu" !== (e = $(this).parent().parent().parent().parent().parent().parent()).attr("id") && e.addClass("show"), "wrapper" !== (t = $(this).parent().parent().parent().parent().parent().parent().parent().parent().parent()).attr("id") && t.addClass("show"), (n = $(this).parent().parent().parent().parent().parent().parent().parent().parent().parent().parent()).is("body") || n.addClass("menuitem-active"))
            })), $("#two-col-sidenav-main").length && (n = $("#two-col-sidenav-main .menu-link"), a = $(".twocolumn-menu-item"), t = $(".twocolumn-menu-item .sub-menu"), (o = $("#two-col-menu menu-item .collapse")).on({
            ...
            }), r = window.location.href, n.each(function() {
                this.href === r && $(this).addClass("active")
            }), $("#two-col-menu a").each(function() {
                var e, t, n, a, o;
                this.href == r && ($(this).addClass("active"), $(this).parent().addClass("menuitem-active"), $(this).parent().parent().parent().addClass("show"), $(this).parent().parent().parent().parent().addClass("menuitem-active"), "sidebar-menu" !== (e = $(this).parent().parent().parent().parent().parent().parent()).attr("id") && e.addClass("show"), $(this).parent().parent().parent().parent().parent().parent().parent().addClass("menuitem-active"), "wrapper" !== (t = $(this).parent().parent().parent().parent().parent().parent().parent().parent().parent()).attr("id") && t.addClass("show"), (n = $(this).parent().parent().parent().parent().parent().parent().parent().parent().parent().parent()).is("body") || n.addClass("menuitem-active"), a = null, o = "#" + $(this).parents(".twocolumn-menu-item").attr("id"), $("#two-col-sidenav-main .menu-link").each(function() {
                    $(this).attr("href") === o && (a = $(this))
                }), a && a.trigger("click"))
            })), setTimeout(function() {
                var e, t, r, n, i, c, s, l, a = document.querySelector("li.menuitem-active .active");
                null != a && (e = document.querySelector(".app-menu .simplebar-content-wrapper"), t = a.offsetTop - 300, e && 100 < t && (n = t, i = 600, c = (r = e).scrollTop, s = n - c, l = 0, function e() {
                    var t, n, a, o = (t = l += 20, n = c, a = s, (t /= i / 2) < 1 ? a / 2 * t * t + n : -a / 2 * (--t * (t - 2) - 1) + n);
        ...
        value: function() {
            ...
            t.id = "custom-backdrop", t.classList = "offcanvas-backdrop fade show", document.body.appendChild(t), "rtl" != (null === (e = document.getElementsByTagName("html")[0]) || void 0 === e ? void 0 : e.getAttribute("dir")) && (document.body.style.overflow = "hidden", 1140 < window.innerWidth && (document.body.style.paddingRight = "15px"));
            var n = this;
        ...
        value: function() {
            sessionStorage.setItem("__UBOLD_CONFIG__", JSON.stringify(this.config)), document.querySelectorAll(".right-bar input[type=checkbox]").forEach(function(e) {
                e.checked = !1
            });
            var e, t, n, a, o, r, i, c, s, l = this.config;
            l && (e = document.querySelector("input[type=checkbox][name=data-bs-theme][value=" + l.theme + "]"), t = document.querySelector("input[type=checkbox][name=data-layout-mode][value=" + l.layout.mode + "]"), n = document.querySelector("input[type=checkbox][name=data-layout-width][value=" + l.layout.width + "]"), a = document.querySelector("input[type=checkbox][name=data-topbar-color][value=" + l.topbar.color + "]"), o = document.querySelector("input[type=checkbox][name=data-menu-color][value=" + l.menu.color + "]"), r = document.querySelector("input[type=checkbox][name=data-menu-icon][value=" + l.menu.icon + "]"), i = document.querySelector("input[type=checkbox][name=data-sidenav-size][value=" + l.sidenav.size + "]"), c = document.querySelector("input[type=checkbox][name=data-two-column-color][value=" + l.sidenav.twocolumn + "]"), s = document.querySelector("input[type=checkbox][name=data-sidebar-user]"), e && (e.checked = !0), t && (t.checked = !0), n && (n.checked = !0), a && (a.checked = !0), o && (o.checked = !0), r && (r.checked = !0), i && (i.checked = !0), c && (c.checked = !0), s && "true" === l.sidenav.user.toString() && (s.checked = !0))
        }
    }, {
        key: "init",
        value: function() {
