                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="category_title" class="form-control" name="title" placeholder="Enter category title" required />
                                    </div>

                                    <div class="mb-3">
                                        <label for="description" class="form-label">Category Description</label>
                                        <textarea class="form-control" name="description" id="description" rows="5" placeholder="Enter a brief description for the category..."></textarea>
                                    </div>
                                </div>
                            </div>
