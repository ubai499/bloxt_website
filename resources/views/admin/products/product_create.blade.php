                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="productname" class="form-control" name="title" placeholder="Enter product name" />
                                    </div>
                            ...
                            <div class="row">
                                    <div class="col-xl-6">
                                        <div class="my-3 mt-xl-0">
                                            <label for="productname" class="mb-0 form-label">Product Image</label>
