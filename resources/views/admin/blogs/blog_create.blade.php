                                ...
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" data-toggle="select2" data-width="100%" name="blog_categories_id">
                                            ...
                                            <option value="{{$blog_category->id}}">{{ ucwords(str_replace('-', ' ', @$blog_category->title)) }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="my-3 mt-xl-0">
                                            <label for="projectname" class="mb-0 form-label">Blog Image</label>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="meta_keywords" class="form-control" name="meta_keywords" placeholder="Enter comma-separated keywords" />
                                    </div>
                                    <div class="mb-3">
                                        <label for="page_url" class="form-label">Page URL</label>
                                        <input type="text" id="page_url" class="form-control" name="page_url" placeholder="Enter page URL" />
                                    </div>
                                    <div class="mb-3">
                                        <label for="page_image" class="form-label">Page Image</label>
                                        <input type="text" id="page_image" class="form-control" name="page_image" placeholder="Enter page image URL" />
                                    </div>
                                </div>
                            </div>
