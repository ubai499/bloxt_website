        ...
        <div class="container">
            <div class="row align-items-center row-bg1">
                <div class="col-lg-2 col-md-6 col-6">
                    <div class="vl-logo">
                        <a href="index.html"><img src="{{ asset('assets/img/logo/logo5.png') }}" alt=""></a>
                    </div>
                </div>
                                            ...
                                            <div class="row gx-3 row-cols-1 row-cols-md-1 row-cols-lg-5">
                                                ...
                                                <div class="col">
                                                    <div class="vl-home-thumb">
                                                        ...
                                                        <a href="index.html">Solarp  - Homepage 01</a>
                                                        <div class="btn-area1">
                                                            <a href="index.html" class="vl-btn6">View Demo <i class="fa-solid fa-arrow-right"></i></a>
                                                        </div>
                                                ...
                                                <div class="col">
                                                    <div class="vl-home-thumb">
                                                        ...
                                                        <a href="index2.html">Solarp  - Homepage 02</a>
                                                        <div class="btn-area1">
                                                            <a href="index2.html" class="vl-btn6">View Demo <i class="fa-solid fa-arrow-right"></i></a>
                                                        </div>
                                                        <div class="space20 d-lg-none d-block"></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col">
                                                    <div class="vl-home-thumb">
                                                        ...
                                                        <a href="index3.html">Solarp  - Homepage 03</a>
                                                        <div class="btn-area1">
                                                            <a href="index3.html" class="vl-btn6">View Demo <i class="fa-solid fa-arrow-right"></i></a>
                                                        </div>
                                                        <div class="space20 d-lg-none d-block"></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col">
                                                    <div class="vl-home-thumb">
                                                        ...
                                                        <a href="index4.html">Solarp  - Homepage 04</a>
                                                        <div class="btn-area1">
                                                            <a href="index4.html" class="vl-btn6">View Demo <i class="fa-solid fa-arrow-right"></i></a>
                                                        </div>
                                                        <div class="space20 d-lg-none d-block"></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col">
                                                    <div class="vl-home-thumb">
                                                        ...
                                                        <a href="index5.html">Solarp  - Homepage 05</a>
                                                        <div class="btn-area1">
                                                            <a href="index5.html" class="vl-btn6">View Demo <i class="fa-solid fa-arrow-right"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col">
                                                    <div class="vl-home-thumb">
                                                        <div class="img1">
                                                            <img src="{{ asset('assets/img/all-images/demo/demo-img6.png') }}" alt="">
                                                        </div>
                                                        <a href="index6.html">Solarp  - Homepage 06</a>
                                                        <div class="btn-area1">
                                                            <a href="index6.html" class="vl-btn6">View Demo <i class="fa-solid fa-arrow-right"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col">
                                                    <div class="vl-home-thumb">
                                                        <div class="img1">
                                                            <img src="{{ asset('assets/img/all-images/demo/demo-img7.png') }}" alt="">
                                                        </div>
                                                        <a href="index7.html">Solarp  - Homepage 07</a>
                                                        <div class="btn-area1">
                                                            <a href="index7.html" class="vl-btn6">View Demo <i class="fa-solid fa-arrow-right"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col">
                                                    <div class="vl-home-thumb">
                                                        <div class="img1">
                                                            <img src="{{ asset('assets/img/all-images/demo/demo-img8.png') }}" alt="">
                                                        </div>
                                                        <a href="index8.html">Solarp  - Homepage 08</a>
                                                        <div class="btn-area1">
                                                            <a href="index8.html" class="vl-btn6">View Demo <i class="fa-solid fa-arrow-right"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col">
                                                    <div class="vl-home-thumb">
                                                        <div class="img1">
                                                            <img src="{{ asset('assets/img/all-images/demo/demo-img9.png') }}" alt="">
                                                        </div>
                                                        <a href="index9.html">Solarp  - Homepage 09</a>
                                                        <div class="btn-area1">
                                                            <a href="index9.html" class="vl-btn6">View Demo <i class="fa-solid fa-arrow-right"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col">
                                                    <div class="vl-home-thumb">
                                                        ...
                                                        <a href="index10.html">Solarp  - Video</a>
                                                        <div class="btn-area1">
                                                            <a href="index10.html" class="vl-btn6">View Demo <i class="fa-solid fa-arrow-right"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
