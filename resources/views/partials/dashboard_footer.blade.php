   ...
   <!-- Chart JS -->
   <script src="{{asset('dashboard_assets/libs/chart.js/Chart.bundle.min.js')}}"></script>

   <script src="{{asset('dashboard_assets/libs/moment/min/moment.min.js')}}"></script>
   <script src="{{asset('dashboard_assets/libs/jquery.scrollto/jquery.scrollTo.min.js')}}"></script>

   <!-- Chat app -->
   <script src="{{asset('dashboard_assets/js/pages/jquery.chat.js')}}"></script>

   <!-- Todo app -->
   <script src="{{asset('dashboard_assets/js/pages/jquery.todo.js')}}"></script>

   <!-- Dashboard init JS -->
   <script src="{{asset('dashboard_assets/js/pages/dashboard-3.init.js')}}"></script>
   ...
   <script src="{{asset('dashboard_assets/libs/flatpickr/flatpickr.min.js')}}"></script>
   <script src="{{asset('dashboard_assets/js/pages/create-project.init.js')}}"></script>
