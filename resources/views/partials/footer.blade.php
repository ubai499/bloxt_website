                  ...
                  <div class="col-lg-12">
                      <div class="cta-content-bg">
                          <div class="row align-items-center">
                              <div class="col-lg-4">
                                  <div class="heading1">
                                      <h2>Get Started with Bloxt Today</h2>
                                  </div>
                              </div>
                              ...
                              <div class="col-lg-5">
                                  <div class="images">
                                      <form>
                                          ...
                                          <button type="submit" class="vl-btn6">Subscribe <i class="fa-solid fa-arrow-right"></i></button>
                                      </form>
                                  </div>
                              </div>
                          </div>
              ...
              <div class="row">
                  <div class="col-lg-4 col-md-6">
                      <div class="footer-logo1">
                          ...
                          <p>Bloxt Ltd is a national organisation working primarily within the ECO industry, where we strive to deliver funded home energy upgrades for eligible customers nationwide.</p>
                  ...
                  <div class="col-lg-3 col-md-6">
                      ...
                      <div class="vl-footer-widget first-padding">
                          ...
                          <ul>
                              <li><a href="index.html">Eco4 Grant Funding</a></li>
                              <li><a href="{{ route('about')}}">Smart Controls</a></li>
                              <li><a href="service.html">electric Heating</a></li>
                              <li><a href="project.html">Loft Insulation</a></li>
                              <li><a href="blog.html">Cavity Wall Insulation</a></li>
                          </ul>
                      </div>
                  </div>
              </div>
              ...
              <div class="row">
                  <div class="col-lg-12">
                      <div class="vl-copyright-area">
                          <p>ⓒCopyright 2025 <span>Bloxt Ltd</span> . All rights reserved</p>
                          <!-- <ul>
