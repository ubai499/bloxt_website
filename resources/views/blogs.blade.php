                ...
                <div class="vl-blog-1-item">
                    ...
                    <div class="vl-blog-1-content">
                        <div class="vl-blog-meta">
                            <ul>
                                <li>
                                    <a href="{{route('blog_details')}}"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        <h4 class="vl-blog-1-title"><a href="{{ route('blog_details')}}">Innovations in Solar Technology</a></h4>
                        ...
                        <div class="vl-blog-1-icon">
                            <a href="{{ route('blog_details')}}" class="readmore">Learn More <i class="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
