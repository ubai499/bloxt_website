        ...
        <div class="row align-items-center">
            <div class="col-lg-12">
                <div class="hero-header text-center">
                    ...
                    <div class="space16"></div>
                    <p data-aos="fade-left" data-aos-duration="1100">
                        Get a stress-free A-rated boiler quote in seconds with no hidden costs, installed as fast as next day.
                    </p>
                    <div class="space38"></div>
                    <div class="play-btns-area" data-aos="fade-left" data-aos-duration="1200">
                        <div class="btn-area1">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="heading5">
                    ...
                    <p>Bloxt were honoured to be invited to a private meeting with His Majesty, King Charles, in 2024 to discuss our ongoing charity works. This special invitation followed on from our commitment to supporting the Southport Community in the aftermath of the 2024 riots. Through our efforts in rebuilding the community, we strived to make a meaningful difference, and it was a privilege to share our progress and future plans with the King himself. </p>
                    <p>At Bloxt, we are dedicated to making a positive impact in our community and are extremely passionate in regards to doing everything we can to help others who need it most.</p>
